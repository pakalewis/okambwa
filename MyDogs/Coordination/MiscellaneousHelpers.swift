...
extension UIViewController {
    func showBanner(text: String, backgroundColor: UIColor) {
        let HEIGHT: CGFloat = 50

        let label = UILabel(frame: CGRect(x: 0, y: view.bounds.maxY, width: view.bounds.width, height: HEIGHT))
